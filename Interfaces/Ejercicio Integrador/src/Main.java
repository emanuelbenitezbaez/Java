public class Main {
    ...
    * Un fanático dePókemon desea implementar para el modelado de un videojuego los diferentes ataques de cada una de estas criaturas.
    ...
    *  atacarArañazo()
    *  atacarMordisco().
    *  Sin embargo, este fanático también desarrolló una serie de interfaces para contemplar los ataques de Pókemons
    *  de cierto tipo:
    ...
    *
    * A  partir  de  estas interfaces, el Pokefanático desea crear las clases que manejen a los personajes principales del videojuego,
    * los cuales son los pokemons starters de la primera temporada Charmander, Bulbasaur Squirtle y Pikachu;
    ...
    * Pókemon mostrando un mensaje en pantalla que indique qué pókemon es y qué ataque está realizando, por ejemplo: “Soy Charmander y estoy atacando
    *  con Ascuas” o “Soy Pikachu y estoy atacando con placaje”.  Luego de realizar lo mencionado, crear las instancias necesarias y llamar
    ...
    * */
       ...
       bulbasaur.atacarDrenaje();
        ...
        squirtel.Araniazo();
        squirtel.Mordisco();
        squirtel.atacarBurbuja();
        squirtel.atacarHidrobomba();
        squirtel.atacarHidropulso();
        squirtel.atacarPistolaAgua();
        System.out.println("||-------------------------------------------------||");
